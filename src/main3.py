...
# - one hot encoder basically
# From integers representing words, at various lengths
# - to a normalized one hot encoded tensor (matrix) of 10k columns
...
# VECTORIZE the labels too - NO INTEGERS only
# floats into a tensor...(rare exceptions)
